...
export const BACKEND_URL =
  process.env.NODE_ENV === "production"
    ? "https://ft-choir-portal.herokuapp.com"
    : "http://localhost:5000";
export const APP_NAME = "FTC Portal";
export const AUTH_TOKEN = "token";
export const EVENT_CATEBORIES = ["rehearsals", "training"];
...
export const STATUS = ["active", "suspended", "inactive"];
export const VOCAL_PARTS = ["Alto", "Tenor", "Soprano", "Musician"];
export const STATES = [
  "Abia",
  "Adamawa",
  "Akwa Ibom",
...
export const WORK_STATUS = ["Employed", "Seeking Employment", "Self-eemployed"];
export const WOFBI_STATUS = ["In view", "BCC", "LCC", "LDC"];
