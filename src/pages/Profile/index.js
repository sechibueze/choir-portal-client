...
const Profile = ({
    ...
    return (
      <span className="data-cta">
        <span
          ...
          onClick={() => setPersonalDataVisibility(true)}
        >
          {" "}
          {meProfileData ? "Edit Personal Data" : "Create Profile"}{" "}
        </span>
      </span>
    );
  };
  const NoData = () => (
    <div className="no-data-component">
      {" "}
      <span> No profile yet...</span> <StartProfileButton />{" "}
    </div>
  );
  return (
    <Fragment>
      <AuthContainer>
        ...
        {meProfileDataRequest && !meProfileData
          ...
          : meProfileData && (
              <ShowMemberImage
                imageUrl={meProfileData.member.imageUrl}
                openModalBox={() => setImageModalStatus(true)}
              />
            )}
        ...
        <div className="data-box">
          ...
          {nokDataVisibility && (
            <Modal
              ...
              dismiss={() => dismiss()}
              component={
                <NOKDataForm nok={meProfileData.nok} _id={match.params._id} />
              }
            />
          )}
          {meProfileDataRequest && !meProfileData
          ...
          {meProfileData && (
            <span className="data-cta">
              <span
                className="btn btn-primary"
                onClick={() => setNOKDataVisibility(true)}
              >
                {" "}
                Edit NOK Data
              </span>
        ...
        <div className="data-box">
          ...
          {churchDataVisibility && (
            <Modal
              ...
              component={
                <ChurchDataForm
                  churchData={meProfileData.church_info}
          ...
          {meProfileDataRequest && !meProfileData
            ...
            ? ""
            : meProfileData && (
                <ShowChurchData churchData={meProfileData.church_info} />
              )}
          {meProfileData && (
            <span className="data-cta">
              <span
                className="btn btn-primary"
                onClick={() => setChurchDatahVisibility(true)}
              >
                {" "}
                Edit Church Data
              </span>
        ...
        <div className="data-box">
          ...
          {unitDatakVisibility && (
            <Modal
              ...
              component={
                <UnitDataForm
                  unitData={meProfileData.unit_info}
                  _id={match.params._id}
                />
              }
            />
          ...
          {meProfileDataRequest && !meProfileData
            ...
            ? ""
            : meProfileData && (
                <ShowUnitData unitData={meProfileData.unit_info} />
              )}
          {meProfileData && (
            <span className="data-cta">
              <span
                className="btn btn-primary"
                onClick={() => setUnitDataVisibility(true)}
              >
                {" "}
                Edit Unit Data
              </span>
