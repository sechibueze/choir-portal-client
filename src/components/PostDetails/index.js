        ...
        <div className="post py-2">
          ...
          <div className="post-content">
            ...
            <div className="post-stats my-1">
              <span
                onClick={() => likeThisPost(postById._id)}
                className="px-1 fa fa-thumbs-up"
              >
                {" "}
                {postById.likes.length}{" "}
              </span>
              <span
                onClick={() => unlikeThisPost(postById._id)}
                className="mx-1 fa fa-thumbs-down"
              >
                {" "}
              </span>
              <span className="mx-1 fa fa-comment-o">
                {" "}
                {postById.comments.length}{" "}
              </span>

              <Link
                to={`/profiles/${postById.user}`}
                className="mx-1 fa fa-user-o"
              >
                {" "}
                {postById.name}{" "}
              </Link>
