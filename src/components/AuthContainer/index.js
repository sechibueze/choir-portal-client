      ...
      <div className="admin-page">
        ...
        <div className="admin-navbar">
          <label
            ...
            className="fa fa-bars fa-2x toggle-sidebar"
          />
          ...
          <ul className="admin-navbar-actions">
            ...
            <li className="drop-down">
              <span to="http://">
                {currentMember.imageUrl ? (
                  <img
                    ...
                    className="admin-navbar-item-image"
                    alt="currenly logged in user"
                    style={{ verticalAlign: "middle" }}
                  />
                ) : (
                  <span
                    className="admin-navbar-item-icon fa fa-user"
                    title="Tables"
                  />
                )}
              ...
              <div className="drop-down-menu">
                <span className="drop-down-menu-link">
                  {" "}
                  <span className="link-icon fa fa-user-alt" /> Hi,{" "}
                  {currentMember.firstname}{" "}
                </span>
                <Link to="/profile" className="drop-down-menu-link">
                  {" "}
                  <span className="link-icon fas fa-user-circle" /> Profile
                </Link>
                ...
                <span onClick={() => logout()} className="drop-down-menu-link">
                  {" "}
                  <span className="link-icon fa fa-chevron-left" /> Logout
                </span>
              </div>
            </li>
          </ul>
