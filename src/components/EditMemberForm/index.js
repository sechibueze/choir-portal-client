...
const EditMemberForm = ({
  ...
  const [editMemberData, setEditMemberData] = useState({
    ...
    access: memberData && memberData.access ? memberData.access : "",
    firstname: memberData && memberData.firstname ? memberData.firstname : "",
    middlename:
      memberData && memberData.middlename ? memberData.middlename : "",
    lastname: memberData && memberData.lastname ? memberData.lastname : "",
    email: memberData && memberData.email ? memberData.email : "",
    password: "",
    phone: memberData && memberData.phone ? memberData.phone : "",
  });
        ...
        >
          <div className="form-logo">
            ...
            <span className="form-type">
              {" "}
              <span className="fas fa-user-edit" /> Update Member
            </span>
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Type member access here"
            />
          </div>
          <div className="form-group">
          ...
          <button
            ...
            disabled={editMemberRequest ? true : false}
          >
...
export default connect(mapStateToProps, { editMember, setAlert })(
  withRouter(EditMemberForm)
);
