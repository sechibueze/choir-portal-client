...
export const SHILOH_SIGNUP_REQUEST = "SHILOH_SIGNUP_REQUEST";
export const SHILOH_SIGNUP_SUCCESS = "SHILOH_SIGNUP_SUCCESS";
export const SHILOH_SIGNUP_FAIL = "SHILOH_SIGNUP_FAIL";

export const EDIT_SHILOH_REQUEST = "EDIT_SHILOH_REQUEST";
export const EDIT_SHILOH_SUCCESS = "EDIT_SHILOH_SUCCESS";
export const EDIT_SHILOH_FAIL = "EDIT_SHILOH_FAIL";

export const DELETE_SHILOH_FAIL = "DELETE_SHILOH_FAIL";
export const DELETE_SHILOH_SUCCESS = "DELETE_SHILOH_SUCCESS";
export const DELETE_SHILOH_REQUEST = "DELETE_SHILOH_REQUEST";

export const SHILOH_DATA_REQUEST = "SHILOH_DATA_REQUEST";
export const SHILOH_DATA_SUCCESS = "SHILOH_DATA_SUCCESS";
export const SHILOH_DATA_FAIL = "SHILOH_DATA_FAIL";

export const SHILOH_LIST_REQUEST = "SHILOH_LIST_REQUEST";
export const SHILOH_LIST_SUCCESS = "SHILOH_LIST_SUCCESS";
export const SHILOH_LIST_FAIL = "SHILOH_LIST_FAIL";
